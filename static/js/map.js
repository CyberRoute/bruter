...
$.getJSON('https://ipapi.co/json/', function(data) {
  ...
  var sourceIpMarker = L.marker([sourceLatitude, sourceLongitude], {icon: L.icon({iconUrl: 'http://maps.google.com/mapfiles/ms/icons/red-dot.png'})}).addTo(map);
  sourceIpMarker.bindPopup("<b>Source IP Address:</b> " + sourceIp).openPopup();

  // add line between source and destination markers
  var line = L.polyline([[sourceLatitude, sourceLongitude], [latitude, longitude]], {color: 'green'}).addTo(map);
